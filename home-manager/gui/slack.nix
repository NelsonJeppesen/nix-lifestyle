...
let
  ...
  slackFlags = lib.concatStringsSep " " [
    ...
    # Give V8 a 4 GiB old-space instead of the ~2 GiB default. With 30 GiB of
    # RAM the memory is free; the win is far fewer major GC pauses in a client
    # that keeps weeks of message history live in the heap.
