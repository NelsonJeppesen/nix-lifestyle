    ...
    profiles = {
      ...
      home = {
        ...
        settings = {
          ...
          #  Background tab throttling  Reduce CPU/battery usage from inactive tabs
          ...
          #  Sleep/unload background tabs  Automatically unload tabs when memory is low
          "browser.tabs.unloadOnLowMemory" = true;
          "browser.tabs.unloadOnLowMemory.delay_ms" = 60000; # Wait 60s before unloading

          #  Rendering performance  Lower frame rate when idle to save power (Wayland compositor path)
